...
export const environment = {
    ...
    claroOtt: {
        ...
        token: '',
        local: '',
        offers: 'https://edx.conecel.com/ocp-silver/ott-web-bff/enterprise/eai/clarodxp/v1.0/offers',
        profiles: 'https://edx.conecel.com/ocp-silver/ott-web-bff/enterprise/eai/clarodxp/v1.0/profiles',
        validateEmail: 'https://edx.conecel.com/ocp-silver/ott-web-bff/enterprise/eai/clarodxp/v1.0/profiles/claroId'
    },
    claroIpTv: {
    ...
    claroVideo: {
        url: 'https://edx.conecel.com/ocp-silver/edx-clarovideo-webbff/enterprise/eai/clarodxp/v1.0',
    ...
    optimus: {
        urlapi: 'https://edx.conecel.com/ocp-silver/edx-payments-webbff/edx-digitalpayment/api/',
        urlapiLogin: 'https://edx.conecel.com/ocp-silver/edx-payments-webbff/edx-digitalpayment/api/'
    },
    claroUp: {
